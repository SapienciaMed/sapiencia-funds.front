  ...
  return (
    <div className="main-page">
      <div className="title-area">
        <p className="text-black huge">
          {valueAction == "edit" ? "Modificar acta" : "Visualizar acta"}
        </p>
      </div>
      ...
      <FormComponent action={onSaveEdit} id="acta-form">
        <section className="card-user">
          <div
            className={`${
              valueAction == "edit"
                ? "grid-form-3-container"
                : "grid-form-4-container"
            }  gap-15`}
          >
            {valueAction !== "edit" && (
              <InputComponent
            ...
            {valueAction == "edit" ? (
              <SelectComponent
                ...
                classNameLabel={`text-black big text-with-colons ${
                  valueAction == "edit" && "text-required"
                }`}
                filter={true}
        ...
        <section className="card-user mt-14px">
          <div className="title-area">
            <label className="text-black large" style={{ margin: "0px" }}>
              Tasas
            </label>
          </div>
          <div className="grid-form-3-container gap-15">
      ...
      {valueAction == "edit" ? (
        <>
          <section className="card-user mt-14px">
            <div className="title-area">
              <label className="text-black extra-large grid-span-4-columns mb-18px">
                Citar
              </label>
            </div>
