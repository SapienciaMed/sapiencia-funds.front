...
const mockResp: IReglamentConsolidation[] =   [
  {
      "id": 17,
      "idProgram": 3,
      "programName": "FONDO FORMACION AVANZADA",
      "initialPeriod": "2015-1",
      "isOpenPeriod": 1,
      "endPeriod": "2025-2",
      "applyTheoreticalSemiannualPercent": null,
      "applyAcademicPerformancePercent": null,
      "academicPerformancePercent": null,
      "applyRequirementsPercent": null,
      "requirementsPercent": null,
      "applySocialService": 1,
      "socialServicePercent": null,
      "socialServiceHours": 80,
      "socialServiceCondonationType": null,
      "socialServiceCondonationPercent": [],
      "applyKnowledgeTransfer": 1,
      "knowledgeTransferPercent": "9.00",
      "knowledgeTransferHours": 50,
      "knowledgeTransferCondonationType": null,
      "knowledgeTransferCondonationPercent": [],
      "gracePeriodMonths": null,
      "graceDateApplication": null,
      "applyContinuousSuspension": 0,
      "continuosSuspencionQuantity": null,
      "applyDiscontinuousSuspension": 0,
      "discontinuousSuspensionQuantity": null,
      "applySpecialSuspensions": 0,
      "specialSuspensionsQuantity": null,
      "applyExtension": 0,
      "extensionQuantity": null,
      "applyCondonationPerformancePeriod": 1,
      "performancePeriodStructure": {
          "percentCondonation": "5",
          "dataTable": [
              {
                  "initialAverage": "0",
                  "endAverage": "5",
                  "percent": "15",
                  "id": "2023-11-17T12:07:21.524Z"
              }
          ]
      },
      "applyAccomulatedIncomeCondonation": 0,
      "accumulatedPerformanceDataTable": null,
      "requirementsForReglament": []
  },
  {
      "id": 19,
      "idProgram": 3,
      ...
      "applyRequirementsPercent": null,
      "requirementsPercent": null,
      "applySocialService": 0,
      "socialServicePercent": null,
      "socialServiceHours": 80,
      "socialServiceCondonationType": null,
      "socialServiceCondonationPercent": [],
      "applyKnowledgeTransfer": 0,
      "knowledgeTransferPercent": null,
      "knowledgeTransferHours": null,
      "knowledgeTransferCondonationType": null,
      "knowledgeTransferCondonationPercent": [],
      "gracePeriodMonths": null,
      "graceDateApplication": null,
      ...
      "applyExtension": 0,
      "extensionQuantity": null,
      "applyCondonationPerformancePeriod": 0,
      "performancePeriodStructure": null,
      "applyAccomulatedIncomeCondonation": 0,
      "accumulatedPerformanceDataTable":null,
      "requirementsForReglament": []
  },
  {
      "id": 21,
      "idProgram": 1,
      "programName": "FONDO PRESUPUESTO PARTICIPATIVO",
      "initialPeriod": "2029-1",
      "isOpenPeriod": 1,
      "endPeriod": "2033-2",
      "applyTheoreticalSemiannualPercent": null,
      "applyAcademicPerformancePercent": null,
      ...
      "socialServiceCondonationPercent":[],
      "applyKnowledgeTransfer": 1,
      "knowledgeTransferPercent": "5.00",
      "knowledgeTransferHours": 100,
      "knowledgeTransferCondonationType": null,
      "knowledgeTransferCondonationPercent": [],
      "gracePeriodMonths": 3,
      "graceDateApplication": "from_date_return",
      "applyContinuousSuspension": 1,
      "continuosSuspencionQuantity": 4,
      "applyDiscontinuousSuspension": 1,
      "discontinuousSuspensionQuantity": 5,
      "applySpecialSuspensions": 1,
      "specialSuspensionsQuantity": 5,
      "applyExtension": 1,
      "extensionQuantity": 6,
      "applyCondonationPerformancePeriod": 1,
      "performancePeriodStructure": {
          "percentCondonation": "1",
          "dataTable": [
              {
                  "initialAverage": "0",
                  "endAverage": "3",
                  "percent": "2",
                  "id": "2023-11-21T22:33:13.431Z"
              },
              {
                  "initialAverage": "3.1",
                  "endAverage": "5",
                  "percent": "50",
                  "id": "2023-11-21T22:36:15.679Z"
              }
          ]
      },
      "applyAccomulatedIncomeCondonation": 1,
      "accumulatedPerformanceDataTable": {
          "percentCondonation": "2",
          "dataTable": [
              {
                  "initialAverage": "3.1",
                  "endAverage": "5",
                  "percent": "3",
                  "id": "2023-11-21T22:33:17.136Z"
              },
              {
                  "initialAverage": "0",
                  "endAverage": "3",
                  "percent": "4",
                  "id": "2023-11-21T22:33:43.540Z"
              }
          ]
      },
      "requirementsForReglament": [
          ...
          },
          {
              ...
              "active": 0,
              "percent": null,
              "description": "Sed erat lorem, fermentum sit amet erat vel, aliquet venenatis nunc.",
              "mandatoryFor": "Servicio social"
          },
          {
              "id": 70,
              "codReglament": 21,
              "active": 1,
              "percent": 10,
              "description": "Vestibulum lectus ex, eleifend vel tempor sit amet, ornare sed eros.",
              "mandatoryFor": "Transferencia de conocimiento"
          },
          {
              "id": 72,
              "codReglament": 21,
              "active": 1,
              "percent": 5,
              "description": "Aenean condimentum nibh ut nibh vestibulum, sit amet tempus tortor bibendum.",
              "mandatoryFor": null
          },
          {
              "id": 73,
          ...
          },
          {
              ...
              "active": 1,
              "percent": null,
              "description": "Ut ultricies eu nulla sed finibus.",
              "mandatoryFor": null
          },
          {
              "id": 75,
              ...
              "active": 1,
              "percent": 20,
              "description": "Pellentesque elementum dui id metus suscipit, vitae iaculis felis bibendum.",
              "mandatoryFor": "Servicio social"
          },
          {
              "id": 76,
              ...
              "active": 1,
              "percent": null,
              "description": "Pellentesque pellentesque ex felis, a laoreet sem pulvinar eu.",
              "mandatoryFor": "Transferencia de conocimiento"
          },
          {
              "id": 78,
              ...
              "active": 1,
              "percent": 11,
              "description": "Maecenas tempus sem diam, sit amet imperdiet arcu viverra vitae.",
              "mandatoryFor": null
          },
          {
              "id": 82,
          ...
          },
          {
              ...
              "active": 1,
              "percent": null,
              "description": "Fusce tristique, diam nec consequat porttitor, lacus eros consectetur turpis, gravida pellentesque tellus odio at nulla.",
              "mandatoryFor": "Rendimiento académico"
          },
          {
              "id": 87,
              "codReglament": 21,
              "active": 1,
              "percent": 3,
              "description": "Sed vel urna semper, commodo nulla sit amet, dignissim turpis.",
              "mandatoryFor": null
          },
          {
              "id": 88,
              ...
              "active": 1,
              "percent": 5,
              "description": "Integer maximus erat ac orci tristique aliquam. Sed porta purus mi.",
              "mandatoryFor": "Transferencia de conocimiento"
          },
          {
              "id": 89,
              ...
              "active": 1,
              "percent": null,
              "description": "Morbi suscipit aliquet cursus. Suspendisse ac nisi non libero vestibulum posuere vel vel nunc.",
              "mandatoryFor": null
          },
          {
              "id": 90,
              ...
              "active": 1,
              "percent": null,
              "description": "Pellentesque et condimentum mauris. Donec vitae lobortis est.",
              "mandatoryFor": null
          }
      ]
  },
  {
      "id": 27,
      "idProgram": 2,
      "programName": "PUAP Línea de Crédito Condonable Pregrado con Recurso Ordinario y Fondo EPM.",
      "initialPeriod": "2015-1",
      "isOpenPeriod": 0,
      "endPeriod": "2016-2",
      "applyTheoreticalSemiannualPercent": 1,
      "applyAcademicPerformancePercent": 1,
      "academicPerformancePercent": "3.50",
      "applyRequirementsPercent": 0,
      "requirementsPercent": "0.00",
      "applySocialService": 1,
      "socialServicePercent": "3.00",
      "socialServiceHours": 150,
      "socialServiceCondonationType": null,
      "socialServiceCondonationPercent": [],
      "applyKnowledgeTransfer": 1,
      "knowledgeTransferPercent": "2.00",
      "knowledgeTransferHours": 100,
      "knowledgeTransferCondonationType": null,
      "knowledgeTransferCondonationPercent": [],
      "gracePeriodMonths": 6,
      "graceDateApplication": "A01",
      "applyContinuousSuspension": 1,
      "continuosSuspencionQuantity": 6,
      "applyDiscontinuousSuspension": 1,
      "discontinuousSuspensionQuantity": 6,
      "applySpecialSuspensions": 1,
      "specialSuspensionsQuantity": 8,
      "applyExtension": 1,
      "extensionQuantity": 1,
      "applyCondonationPerformancePeriod": 0,
      "performancePeriodStructure": null,
