      ...
      return element == "name" ? (
        ...
        <>
         <Tooltip target=".Manage" style={{borderRadius:'1px'}} />
          <i className="custom-target-icon pi pi-envelope p-text-secondary p-overlay-badge flex justify-center Manage"
...
const leftContent = (title: string, isInputSearch: boolean, onGlobalFilterChange?: (value: React.ChangeEvent<HTMLInputElement>) => void) => {
