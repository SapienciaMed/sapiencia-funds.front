...
interface Atributos {
  ...
  filesAccept: string;
  titleFilesAccept: string
}

const UploadNewComponent = (props: Atributos) => {
  const { id, filesAccept, titleFilesAccept, dataArchivo } = props;
  ...
  const emptyTemplate = () => {
    ...
    return (
        <div style={containerStyle}>
            ...
            <p style={{ color: 'red' }}>{titleFilesAccept}</p>
            </span>
...
export default React.memo(UploadNewComponent)